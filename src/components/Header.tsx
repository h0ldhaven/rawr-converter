    ...
    return(
        <header className='relative overflow-clip'>
            ...
            <div className='flex flex-col items-center justify-center w-full h-full px-4 md:flex-row sm:px-8 md:px-16 my-2'>
                ...
                <div className='text-shadow-custom flex flex-col items-center justify-center text-center w-full md:w-auto md:ml-16 md:pt-24 pb-10 md:pb-16 leading-none text-black font-roboto uppercase text-[3em] z-10 mt-6 sm:mt-10 md:mt-16'>
                    <h1>{appName}</h1>
                </div>
            </div>
        </header>
